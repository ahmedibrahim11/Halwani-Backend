...
namespace Halwani.Data.Migrations
{
    ...
    [Migration("20210819201941_addDescriptionForGroup")]
    partial class addDescriptionForGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Halwani.Data.Entities.Incident.Ticket", b =>
                {
                    ...
                    b.Property<string>("EsclationReason")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Halwani.Data.Entities.Notification.Notification", b =>
                {
            ...
            modelBuilder.Entity("Halwani.Data.Entities.Team.UserTeams", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Halwani.Data.Entities.location.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Halwani.Data.Entities.Team.UserTeams", b =>
                {
                    ...
                    b.HasOne("Halwani.Data.Entities.User.User", "User")
                        .WithMany("UserTeams")
